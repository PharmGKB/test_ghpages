...
This documentation shares two concrete examples of how to use PharmCAT to batch process multiple samples in a High-Performance Computing (HPC) environment.
...
We presume that you have familiarized yourself with using [PharmCAT's VCF preprocessor](/using/VCF-Preprocessor.md).
