...
The requirements for the VCF input file for PharmCAT are described in the VCF [requirement doc](/specifications/VCF-Requirements.md). This document explores some reasoning behind those requirements and some specific examples of ways to fulfill them.
